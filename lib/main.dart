...
Future<List<Post>> fetchPost() async {
  final response = await http.get('https://opentdb.com/api.php?amount=10&category=27&difficulty=easy&type=multiple');
                    ...
                    children: [
                      Card(
                        ...
                        shape: RoundedRectangleBorder(
                          side: new BorderSide(color: Color(0xff89CFF0), width: 2.0),
                        ...
                        child: LabeledRadio(
                          ...
                          onChanged: (int value) {
                            setState(() {
                              _character = value;
                              if( snapshot_copy.data[index].incorrectAnswers[3]== snapshot_copy.data[index].correctAnswer){
                               // count++;
                              }
                            });
                          },
                      ...
                      Card(
                        ...
                        child: LabeledRadio(
                          ...
                          onChanged: (int value) {
                            setState(() {
                              _character = value;
                              if( snapshot_copy.data[index].incorrectAnswers[0]== snapshot_copy.data[index].correctAnswer){
                               // count++;
                              }
                            });
                          },
                      ...
                      Card(
                        ...
                        child: LabeledRadio(
                          ...
                          onChanged: (int value) {
                            setState(() {
                              _character = value;
                              if( snapshot_copy.data[index].incorrectAnswers[1]== snapshot_copy.data[index].correctAnswer){
                               // count++;
                              }
                            });
                          },
                      ...
                      Card(
                        ...
                        child: LabeledRadio(
                          ...
                          onChanged: (int value) {
                            setState(() {
                              _character = value;
                              if( snapshot_copy.data[index].incorrectAnswers[2]== snapshot_copy.data[index].correctAnswer){
                              //  count++;
                              }
                            });
                          },
                      ...
                      GestureDetector(
                        child:Container(
                          ...
                          child:Text(
                            index<snapshot_copy.data.length-1?"Next":"Submit",
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 25.0,
                              fontWeight: FontWeight.bold,
